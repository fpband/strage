...
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 **طراح ربات :** @FarshidBand

"""
	HOME_TEXT = """
**سلام [{}](tg://user?id={}) عزیز خوش آمدید ❤**\n\n**• من ربات ذخیره ساز انواع فایل ها هستم**.

**🎭 برای دریافت لینک دائمی اشتراک گذاری فایل ها ، فایل مربوطه خود را به ربات ارسال نمایید.**

**🖍️طراح ربات : [FarshidBand](t.me/FarshidBand) **
"""
